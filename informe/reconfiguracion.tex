...
nodos (es decir, que el grafo solución fuera un arbol). Por lo tanto, \textbf{nuestro objetivo es que $R$ sea el conjunto de aristas de un árbol generador del grafo de entrada.} %ejes
